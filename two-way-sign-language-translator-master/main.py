...
op_dest="C:\\Users\\Asus\\OneDrive\\Desktop\\two-way-sign-language-translator-master\\filtered_data\\"
alpha_dest="C:\\Users\\Asus\\OneDrive\Desktop\\two-way-sign-language-translator-master\\alphabet\\"
    ...
    def __init__(self, parent, controller):
        ...
        def start_video():
            ...
            def video_stream():
                ...
                tmp_text = img_text[0:]
                img_text = give_char()
                if tmp_text!= img_text and img_text!= '':
                    print(tmp_text)
